...
init() {
    ...
    APTPACKAGES="git python3 python3-pip python3-venv python3-setuptools avrdude apache2 php libapache2-mod-php php-cli php-cgi php-mbstring php-xml libatlas-base-dev python3-numpy python3-scipy"
